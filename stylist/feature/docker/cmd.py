...
@click.pass_obj
def build(stylist, tag, ask, subproject, profile=None, project_name=None, working_dir=None, docker_args=None):
    """
    ...
    with stylist.features.docker(subproject) as docker:
        print docker
